/* ==========================================================================
   TELA: LISTA DE PRESTADORES (Módulo Visitante)
...
function renderizarResultados(lista) {
  ...
  grade.innerHTML = itensDaPagina.map((prestador) => `
    <article class="prestador-card card">
      ...
      <a href="perfil-prestador.html" style="position:absolute;inset:0;" aria-label="Ver perfil de ${prestador.nome_fantasia}"></a>
    </article>
  `).join('');
